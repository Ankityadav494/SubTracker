...
export const btnSecondaryClass =
  "rounded-xl border border-stone-600 bg-stone-800/60 px-4 py-2 text-sm font-medium text-stone-200 transition hover:border-orange-500/60 hover:text-orange-200";

export const cardClass =
  "rounded-2xl border border-stone-800/80 bg-stone-900/70 p-6 shadow-xl shadow-black/30 backdrop-blur";

export const statCardClass =
  "rounded-2xl border border-stone-800/60 bg-gradient-to-br from-stone-900/90 to-stone-950/90 p-4 shadow-sm";
...
export const subheadingClass = "text-lg font-semibold text-stone-100";

export const labelClass =
  "mb-1.5 block text-left text-sm font-medium text-stone-400";

export const errorClass =
  "rounded-xl border border-rose-500/30 bg-rose-500/10 px-4 py-2 text-sm text-rose-300";
